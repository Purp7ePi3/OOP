...
import it.unibo.inheritance.impl.NewStrictBank;
...
public class TestBankAccount {
    ...
    public static void main(final String[] args) {
        ...
        final BankAccount bianchisAccount = new NewStrictBank(aBianchi.getUserID(), 0);
        requireSameAmount(rossisAccount, bianchisAccount);
        // First deposita
        rossisAccount.deposit(aRossi.getUserID(), INTIAL_AMOUNT);       //deposito 10000
        bianchisAccount.deposit(aBianchi.getUserID(), INTIAL_AMOUNT);   //deposito 10000
        requireSameAmount(rossisAccount, bianchisAccount);


        // Withdraw
        rossisAccount.withdraw(aRossi.getUserID(), WITHDRAW_AMOUNT);        //prelevo 15000
        bianchisAccount.withdraw(aBianchi.getUserID(), WITHDRAW_AMOUNT);    //prelevo 15000 //Non posso
        requireSameAmount(rossisAccount, bianchisAccount);
        // Second deposit
